...
import com.smartdevelopers.kandie.nicedrawer.common.dummydata.Cheeses;

import java.util.List;

/**
 * Created by 4331 on 31/07/2015.
 */
public class SwipeListFragment extends SwipeRefreshListFragment {
    public static final String TAG = "SwipeRefresh";
    private static final String LOG_TAG = SwipeListFragment.class.getSimpleName();
